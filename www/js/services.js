...
.factory('recipeService',function($firebaseArray) {
	var fb = new Firebase('https://shop-4eac7.firebaseio.com/menu');
...
.factory('fireBaseData', function($firebase,$firebaseArray) {
	var ref = new Firebase("https://shop-4eac7.firebaseio.com/"),
    refCart = new Firebase("https://shop-4eac7.firebaseio.com/cart"),
    refUser = new Firebase("https://shop-4eac7.firebaseio.com/users"),
    refCategory = new Firebase("https://shop-4eac7.firebaseio.com/category"),
    refOrder = new Firebase("https://shop-4eac7.firebaseio.com/orders"),
    refFeatured = new Firebase("https://shop-4eac7.firebaseio.com/featured"),
    refMenu = new Firebase("https://shop-4eac7.firebaseio.com/menu"),
    refSlider = new Firebase("https://shop-4eac7.firebaseio.com/slider")
    ;
